...
training_unlabel_data_path = sys.argv[2]
train_with_label = os.path.join(path_prefix, training_label_data_path)
train_no_label = os.path.join(path_prefix, training_unlabel_data_path)
# testing_data = os.path.join(path_prefix, 'testing_data.txt')

w2v_path = os.path.join(path_prefix, output) # 處理 word to vec model 的路徑
...
# 製作一個 model 的對象
model = LSTM_Net(embedding, embedding_dim=250, hidden_dim=250, num_layers=5, dropout=0.7, fix_embedding=fix_embedding)
